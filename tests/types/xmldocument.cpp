...
TEST(XmlDocumentSerializationTest, SerializationCache) {
	...
	isEqual(v8 { 0x07, 0x00 }, AmfXmlDocument("").serialize(ctx));
	isEqual(v8 { 0x07, 0x02 }, AmfXmlDocument("foo").serialize(ctx));
...
TEST(XmlDocumentSerializationTest, SerializationCacheNotShared) {
	...
	isEqual(v8 { 0x07, 0x07, 0x64, 0x6f, 0x6f }, AmfXmlDocument("doo").serialize(ctx));
}
...
TEST(XmlDocumentDeserializationTest, SimpleValues) {
	...
	deserializesTo("<asd><foo bar='asd'>qux</foo><boo/></asd>", v8 {
		0x07, 0x53, // U29X-value, length = 41
    0x3c, 0x61, 0x73, 0x64, 0x3e, 0x3c, 0x66, 0x6f, 0x6f, 0x20, 0x62, 0x61,
    0x72, 0x3d, 0x27, 0x61, 0x73, 0x64, 0x27, 0x3e, 0x71, 0x75, 0x78, 0x3c,
    0x2f, 0x66, 0x6f, 0x6f, 0x3e, 0x3c, 0x62, 0x6f, 0x6f, 0x2f, 0x3e, 0x3c,
    0x2f, 0x61, 0x73, 0x64, 0x3e
...
TEST(XmlDocumentDeserializationTest, ObjectReference) {
	...
	deserializesTo("foo", v8 { 0x07, 0x02 }, 0, &ctx);
